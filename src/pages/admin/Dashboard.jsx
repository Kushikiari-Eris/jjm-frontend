...
const Dashboard = () => {
    ...
    const fetchProduct = async () => {
        try {
        const response = await axiosInstance.get(`${BASE_URL}/showAllProduct`);
            ...
            <div className="grid grid-cols-2 gap-2 mb-4">
                ...
                <div className="grid grid-rows-3 grid-flow-col gap-4">
                    ...
                    <dialog id="my_modal_1" className="modal">
                        <div className="container mx-auto py-10 px-8 border bg-white max-h-[90vh] overflow-auto rounded-lg relative">
                            <h3 className="text-2xl font-bold mb-4 text-center ml-5">New Product Listing</h3>
